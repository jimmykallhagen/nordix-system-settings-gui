...
"""Nordix Default Applications GUI
...
MIME_CATEGORIES = {
    'Text/Code Editor': {
        'default': 'gnome-text-editor.desktop',
        'mime_types': [
            'text/plain',
            'text/x-csrc',
            'text/x-chdr',
...
SYSTEM_DEFAULTS_PATH = Path.home() / ".config" / "nordix" / "desktop" / "config" / "system-defaults.conf"
    ...
    def save(self):
        ...
        try:
            ...
            lines = [
                ...
                '# ##=========================================##',
                '# ',
                '# Generated by Nordix Default Apps GUI',
                ...
                '$shot-area = /usr/lib/nordix/scripts/yggdrasil/grimblast-selected-area.sh',
                '$shot-screen = /usr/lib/nordix/scripts/yggdrasil/grimblast-active-screen.sh',
                '$shot-clipboard = /usr/lib/nordix/scripts/yggdrasil/grimblast-to-clipboard.sh',
                '$shot-app = /usr/lib/nordix/scripts/yggdrasil/grimblast-active-application.sh',
...
class NordixDefaultAppsWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, app):
        super().__init__(application=app, title="Nordix Default Applications")
