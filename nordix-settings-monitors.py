...
# Config path
CONFIG_PATH = Path.home() / ".config/nordix/desktop/config/nordix-monitors.conf"
...
class MonitorSettings:
 ...
 ##==================================================##
  #               Nordix - Hyprland                  #
  #   Hyprland Configuration - HDR, 10-BIT support   #
 ##==================================================##
 #
 # * Generated by Nordix Monitor GUI


 ##==================================================##
  #     ADVANCED - EXPERIMENTAL HDR SETUP            #
 ##==================================================##
 #
...
##
## requires wayland-enabled proton version:
## ENABLE_HDR_WSI=1 DXVK_HDR=1 DISPLAY=DP-3 (DP-1,DP-2,DP-3... displayport 1, 2 or 3) %command% 
## For HDMI:
## ENABLE_HDR_WSI=1 DXVK_HDR=1 DISPLAY=HDMI-A-1 (HDMI-A-1,HDMI-A-2,HDMI-A-3... hdmi port 1, 2 or 3) %command% 
##
## Non-steam:
## ENABLE_HDR_WSI=1 DXVK_HDR=1 WINE_HDR_ENABLE=1 DISPLAY= wine executable.exe
##
## Video:
...
class MonitorPanel(Gtk.Box):
    ...
    def setup_ui(self, title):
        ...
        if self.is_secondary:
            group.set_description("Recommended: Left side, locked to Workspace 1")
        else:
...
class NordixMonitorWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, app):
        super().__init__(application=app, title="Nordix Monitor Settings")
    ...
    def setup_ui(self):
        ...
        mode_options = [
            ...
            ('Dual Monitor (Recommended setup)', 'dual'),
        ]
