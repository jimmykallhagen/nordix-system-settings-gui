...
# FILE PATH
# =============================================
ENV_CONFIG_PATH = Path.home() / ".config" / "nordix" / "desktop" / "config" / "environment.conf"
...
class EnvironmentSettings:
    ...
    def load(self):
        """Load current environment.conf"""
        if not self.config_path.exists():
            print(f"environment.conf not found, will create with defaults")
...
{env('NO_AT_BRIDGE', '1')}
{env('_JAVA_OPTIONS', '"-Dawt.useSystemAAFontSettings=on -Dswing.aatext=true -Dswing.defaultlaf=com.sun.java.swing.plaf.gtk.GTKLookAndFeel -Dswing.crossplatformlaf=com.sun.java.swing.plaf.gtk.GTKLookAndFeel ${{_JAVA_OPTIONS}}"')}
...
#
# ** Default in Nordix anyway **
##=============================##
#  env = AMD_DEBUG=lowlatencydec
##=============================##
#
#
...
class NordixEnvironmentWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, app):
        super().__init__(application=app, title="Nordix Environment")
