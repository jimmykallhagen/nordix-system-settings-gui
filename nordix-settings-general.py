...
# FILE PATH
# =============================================
CONFIG_PATH = Path.home() / ".config" / "nordix" / "desktop" / "config" / "nordix-general.conf"
...
# ================================================
#
# Generated by Nordix General Settings GUI
...
class NordixGeneralWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, app):
        super().__init__(application=app, title="Nordix General Settings")
