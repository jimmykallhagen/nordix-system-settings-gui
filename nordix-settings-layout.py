...
CONFIG_PATH = Path.home() / ".config" / "nordix" / "desktop" / "config" / "nordix-layout.conf"
SCRIPTS_PATH = Path.home() / ".config" / "nordix" / "desktop" / "scripts"
...
class LayoutSettings:
    ...
    def generate_config(self):
        ...
        # When tiling is OFF, force dwindle as the layout (base for traditional desktop)
        active_layout = s['g_layout'] if s['tiling_enabled'] else 'dwindle'
 ...
 ##==============================================##
 #
 # * Generated by Nordix Layout Settings GUI
...
class NordixLayoutWindow(Adw.ApplicationWindow):
    def __init__(self, app):
        super().__init__(application=app, title="Nordix Layout Settings")
