...
# FILE PATH
# =============================================
CONFIG_PATH = Path.home() / ".config" / "nordix" / "desktop" / "config" / "nordix-advanced.conf"
...
# ================================================
#
# Generated by Nordix Advanced Settings GUI
...
class NordixAdvancedWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, app):
        super().__init__(application=app, title="Nordix Advanced Settings")
