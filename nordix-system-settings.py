        ...
        'entries': [
            {
                ...
                'command': '/usr/bin/nordix-settings-general.py',
            },
            {
                'id': 'monitors',
                ...
                'command': '/usr/bin/nordix-settings-monitors.py',
            },
            {
                'id': 'decorations',
                ...
                'command': '/usr/bin/nordix-settings-decorations.py',
            },
            {
                'id': 'layout',
                ...
                'command': '/usr/bin/nordix-settings-layout.py',
            },
            {
                'id': 'groups',
                ...
                'command': '/usr/bin/nordix-settings-groups.py',
            },
        ],
    },
    {
        ...
        'entries': [
            {
                ...
                'command': '/usr/bin/nordix-settings-environment.py',
            },
            {
                'id': 'input',
                ...
                'command': '/usr/bin/nordix-settings-input.py',
            },
            {
                'id': 'binds',
                ...
                'command': '/usr/bin/nordix-settings-binds.py',
            },
            {
                'id': 'default-apps',
                ...
                'command': '/usr/bin/nordix-default-apps.py',
            },
        ],
    },
    {
        ...
        'entries': [
            {
                ...
                'command': '/usr/bin/nordix-settings-advanced.py',
            },
        ],
    },
]
