...
DEFAULT_SETTINGS = {
    ...
    'gb_font_size': 12,
    'gb_font_weight_active': 'normal',
    'gb_font_weight_inactive': 'normal',
    'gb_gradients': True,
    'gb_height': 20,
    'gb_indicator_gap': 0,
    'gb_indicator_height': 3,
    'gb_stacked': True,
    'gb_priority': 3,
    ...
    # Groupbar rounding
    'gb_rounding': 1,
    'gb_rounding_power': 5.0,
    'gb_round_only_edges': True,
    'gb_gradient_round_only_edges': True,
    # Groupbar gaps
    'gb_gaps_in': 2,
    'gb_gaps_out': 2,
    ...
    'gb_blur': False,
    # Groupbar colors
    'gb_text_color': '$nordix-artic',
    'gb_col_active': '$nordix-blue',
    'gb_col_inactive': '$nordix-artic',
...
# FILE PATH
# =============================================
CONFIG_PATH = Path.home() / ".config" / "nordix" / "desktop" / "config" / "nordix-groups.conf"
...
# ================================================
#
# Generated by Nordix Groups Settings GUI

~/.config/nordix/system/color/colors.conf
...
class NordixGroupsWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, app):
        super().__init__(application=app, title="Nordix Groups Settings")
    ...
    def setup_ui(self):
        ...
        self.widgets['gb_rounding'] = SliderRow(
            "Rounding", "How much to round the indicator [0 - 15]",
            0, 15, 1, self.settings.settings['gb_rounding'],
        ...
        self.widgets['gb_rounding_power'] = SliderRow(
            "Rounding Power", "Rounding curve: 1.0 triangle, 2.0 circle, 4.0 squircle [1.0 - 10.0]",
            1.0, 10.0, 0.5, self.settings.settings['gb_rounding_power'],
